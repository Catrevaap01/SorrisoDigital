...
import { listarDentistas, DentistaProfile, resetarSenhaDentista } from '../../services/dentistaService';
...
const AdminPasswordRecoveryScreen: React.FC = () => {
  ...
  const handleRecuperarSenha = async () => {
    ...
    try {
      // 1. Resetar senha
      const resetResult = await resetarSenhaDentista(dentistaSelecionado.id);
